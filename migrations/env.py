...
import src.db_models.db_models  # не удалять импорт!
...
sql_url = config.get_main_option("sqlalchemy.url")
...
def run_migrations_online():
    ...
    def include_object(object, name, type_, reflected, compare_to):
        # Игнорирует таблицу spatial_ref_sys для postgis
